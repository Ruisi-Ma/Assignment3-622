...
login("put your hugging face token here")
...
few_shot_intro = """You're a helpful assistant trained to detect stance in Reddit posts. The possible stances are: [Support, Neutral, Oppose].
